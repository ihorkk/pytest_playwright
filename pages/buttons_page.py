...
class Buttons:
    ...
    def check_double_click_result(self) -> None:
        ...
        assert self.__double_click_msg.text_content() == 'You have done a double click', \
            f'Expected a double click message, got {self.__double_click_msg.text_content()} instead'
    ...
    def check_right_click_result(self) -> None:
        ...
        assert self.__right_click_msg.text_content() == 'You have done a right click', \
            f'Expected a right click message, got {self.__right_click_msg.text_content()} instead'

    def perform_dynamic_click(self) -> None:
        self.__dynamic_btn.click()

    def check_dynamic_click_result(self) -> None:
        ...
        assert self.__dynamic_click_msg.text_content() == 'You have done a dynamic click', \
            f'Expected a dynamic click message, got {self.__dynamic_click_msg.text_content()} instead'
